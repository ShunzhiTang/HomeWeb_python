...
from network.NetWorkHandlers import add_static,add_routes
...
async def init(loop):
    ...
    await database.MysqlHelper.create_pool(loop=loop,host='127.0.0.1', port=3306, user='www-data', password='www-data', database='homePage')
